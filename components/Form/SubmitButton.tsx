...
function SubmitButton() {
  ...
  return (
    <button
      ...
      className="relative w-[165px] py-2.5 text-white dark:text-black rounded-md bg-gray-800 dark:bg-gray-100 font-montserrat font-bold disabled:opacity-50 disabled:cursor-not-allowed"
      disabled={pending}
    >
      {pending && (
