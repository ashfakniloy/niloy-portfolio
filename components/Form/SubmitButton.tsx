...
function SubmitButton() {
  ...
  return (
    <button
      ...
      className="relative w-[165px] py-2.5 text-white dark:text-black rounded-md bg-stone-900 dark:bg-gray-100 font-montserrat font-bold disabled:opacity-70 disabled:cursor-not-allowed"
      disabled={pending}
    >
      {pending && (
